			...
			resp.getItems().stream()
				.forEach(sr -> {
					...
					*/
					...
					ActorSystem<SimilarityAPIActor.Similarity> helloActor = ActorSystem.create(SimilarityAPIActor.create(), "SimilarityAPIActor");
					
					
					helloActor.tell(new Similarity(sri.getTitle(), term, null));
